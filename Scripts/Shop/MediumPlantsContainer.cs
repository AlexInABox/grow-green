...
using System.Collections.Generic;
	...
	public partial class MediumPlantsContainer : HBoxContainer
{
	...
	private void PlaceAllPlants(List<Plant> plantList) {
		...
		foreach (Plant plant in plantList) {
			...
			DifficultyLabel.Text = "mittel";
			DifficultyLabel.AddThemeColorOverride("font_color", new Color(0.9882352941176471f, 0.6627450980392157f, 0.396078431372549f));
